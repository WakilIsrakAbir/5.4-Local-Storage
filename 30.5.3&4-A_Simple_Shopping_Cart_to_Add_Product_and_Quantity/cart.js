...
const handleAddProducts = () => {
    ...
    // console.log("Products Add", product, quantity);
 ...
 * 1. get the item from the local storage and it will be JSON string
 * 2. convert the JSON to js object by using JSON.perse
 */